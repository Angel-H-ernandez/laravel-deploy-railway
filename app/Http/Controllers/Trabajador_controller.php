...
class Trabajador_controller extends Controller
{
    ...
    public function index($id_usuario)
    {
        ...
        if ($trabajadores->isEmpty()) {
            $data = [
                "mensaje" =>
                    "No se encontraron trabajadores asociados a ese id",
                "status" => 404,
            ];
    ...
    public function store(Request $request)
    {
        ...
        $trabajador = Trabajador_model::create([
            ...
            "cuenta_bancaria" => Crypt::encryptString(
    ...
    public function update(Request $request, $id)
    {
        ...
        $trabajador->telefono = Crypt::encryptString(
        ...
        $trabajador->cuenta_bancaria = Crypt::encryptString(
            $request->cuenta_bancaria
        );
